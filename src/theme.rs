...
impl Palette {
    ...
    pub const FLEXOKI_LIGHT: Palette = Palette {
        ...
        border: Color::Rgb(0xda, 0xd8, 0xce), // base-150
        ...
        sel_bg: Color::Rgb(0xe6, 0xe4, 0xd9), // base-100
    };
    ...
    pub const FLEXOKI_DARK: Palette = Palette {
        ...
        border: Color::Rgb(0x34, 0x33, 0x31), // base-850
        ...
        sel_bg: Color::Rgb(0x28, 0x27, 0x26), // base-900
    };
